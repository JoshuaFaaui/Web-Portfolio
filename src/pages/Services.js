...
import '../styles/Services/Content/Services.sass'
...
function Services() {
  ...
  return (
    <motion.div initial={{ opacity: -1 }} animate={{ opacity: 1, transition: { duration: 1 } }} exit={{ opacity: 0, transition: { duration: 1 } }} id='ServicesFoundation'>
      <Helmet>
        <title>Web Served - Web Services</title>
        <meta name='description' content="check out our latest website services!" />
        <link rel='canonical' href='/services'/>
      </Helmet>
      <ServicesNav/>
      <CustomText text="ꜱᴇʀᴠɪᴄᴇꜱ"/>
